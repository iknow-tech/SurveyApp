    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserSurvey", x => new { x.AppUsersId, x.SurveysId });
                    table.ForeignKey(
                        name: "FK_AppUserSurvey_AspNetUsers_AppUsersId",
                        column: x => x.AppUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserSurvey_Surveys_SurveysId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserSurvey_SurveysId",
                table: "AppUserSurvey",
                column: "SurveysId");
